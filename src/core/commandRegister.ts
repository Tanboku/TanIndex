...
import calcCommand from "./commands/calc/calcCommand";
import weatherCommand from "./commands/weather/weatherCommand";
import themeCommand from "./commands/theme/themeCommand";
import fontsizeCommand from "./commands/fontsize/fontsizeCommand";
import opacityCommand from "./commands/opacity/opacityCommand";
